...
namespace RemitaMiddleWare.Helpers
{
    ...
    {
        public RijndaelManaged GetManagedEncryption(String secretKey, String initVector)
        {
        ...
        public String Encrypt(String plainText, String secretKey, String initVector)
        {
            ...
            return Convert.ToBase64String(Encrypt(plainBytes, GetManagedEncryption(secretKey, initVector)));
        }
