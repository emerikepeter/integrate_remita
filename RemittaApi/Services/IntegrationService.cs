...
namespace RemitaMiddleWare.Services
{
    public class IntegrationService
    {
        ...
        public IntegrationService(IConfiguration configuration)
        {
            ...
            baseUrl = _configuration["RemittaConfig:BaseUrl"];
            environment = _configuration["RemittaConfig:Environment"];

            merchantid = Constance.MERCHANTID;
            apikey = Constance.APIKEY;
            apitoken = Constance.APITOKEN;
            iv = Constance.IV;
            enckey = Constance.ENCKEY;
        }
